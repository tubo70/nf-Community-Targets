...
/*
 * Setup for Openedv STM32F407-Discovery board.
 */

/*
 * Board identifier.
 */
#define BOARD_OPENEDV_STM32F407_DISCOVERY
#define BOARD_NAME                  "Openedv STM32F407-Discovery"
...
#define GPIOF_LED0                  9U
#define GPIOF_LED1                  10U
...
#define LINE_LED0                   PAL_LINE(GPIOF, 9U)
#define LINE_LED1                   PAL_LINE(GPIOF, 10U)
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_PIN0) |          \
                                     ...
                                     PIN_OSPEED_MEDIUM(GPIOB_USART3_TX) |   \
                                     PIN_OSPEED_MEDIUM(GPIOB_USART3_RX) |   \
 ...
 * PF9  - LED0                      (output pushpull low).
 * PF10 - LED1                      (output pushpull low).
...
#define VAL_GPIOF_MODER             (PIN_MODE_INPUT(GPIOF_PIN0) |           \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOF_LED0) |          \
                                     PIN_MODE_OUTPUT(GPIOF_LED1) |          \
...
#define VAL_GPIOF_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOF_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOF_LED0) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOF_LED1) |       \
...
#define VAL_GPIOF_OSPEEDR           (PIN_OSPEED_HIGH(GPIOF_PIN0) |          \
                                     ...
                                     PIN_OSPEED_LOW(GPIOF_LED0) |           \
                                     PIN_OSPEED_LOW(GPIOF_LED1) |           \
...
#define VAL_GPIOF_PUPDR             (PIN_PUPDR_FLOATING(GPIOF_PIN0) |       \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOF_LED0) |       \
                                     PIN_PUPDR_FLOATING(GPIOF_LED1) |       \
...
#define VAL_GPIOF_ODR               (PIN_ODR_HIGH(GPIOF_PIN0) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOF_LED0) |             \
                                     PIN_ODR_HIGH(GPIOF_LED1) |             \
...
#define VAL_GPIOF_AFRH              (PIN_AFIO_AF(GPIOF_PIN8, 0U) |          \
                                     PIN_AFIO_AF(GPIOF_LED0, 0U) |          \
                                     PIN_AFIO_AF(GPIOF_LED1, 0U) |          \
